    ...
    public sealed class TokenDeliveryPipeline
    {
        ...
        public void Deliver(World world, Tick tick, TokenBus tokenBusOut, TokenBus tokenBusIn, Telemetry telemetry)
        {
            ...
            for (int i = 0; i < _outBuffer.Count; i++)
            {
                ...
                // Così la UI può mostrare "che cosa hai sentito" senza dipendere
                ...
                //   perché sono segnali sociali più importanti del generico TokenIn.
        ...
        ///   Questo è utile in debug e future UI (es: tooltip "ho sentito che NPC#X è un ladro").
        /// </summary>
