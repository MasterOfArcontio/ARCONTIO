...
namespace Arcontio.Core
{
    ...
    /// </para>
    ///
    /// <para><b>v0.13b - Chiusura progressiva MBQD/Incarichi</b></para>
    /// <para>
    ...
    /// </para>
    ///
    /// <para><b>Behavior-preserving bridge</b></para>
    /// <para>
    ...
    public sealed class FoodDecisionJobOrchestrator
    {
        ...
        /// <summary>
        /// <para>
        /// Conserva il gate job anche quando il chiamante arriva dal ramo fame legacy.
        /// </para>
        /// </summary>
            ...
            out string targetSource)
        {
            ...
            foodObjectId = FindVisibleCommunityFoodStock(world, npcId, maxRangeCells);
            ...
            foodObjectId = FindRememberedCommunityFoodStock(world, npcId, maxRangeCells, out targetX, out targetY);
            if (foodObjectId != 0)
            {
