...
namespace Arcontio.Core.Config
{
    ...
    public sealed class SimulationParams
    {
        ...
        public PerceptionDependencyMapParams perception_dependency_map = new PerceptionDependencyMapParams();
    ...
    // =============================================================================
    // PerceptionDependencyMapParams
    // =============================================================================
    /// <summary>
    /// <para>
    /// Parametri runtime della mappa di dipendenze percettive.
    /// </para>
    ///
    /// <para><b>Principio architetturale: memoria percettiva bounded</b></para>
    /// <para>
    /// La mappa viene creata solo quando abilitata. Quando e' spenta, i sistemi
    /// percettivi non registrano dipendenze e le mutazioni del World non propagano
    /// dirty percettivi. La v0.20 usera' questi dirty insieme alla cadenza.
    /// </para>
    ///
    /// <para><b>Struttura interna:</b></para>
    /// <list type="bullet">
    ///   <item><b>enabled</b>: crea o congela completamente la mappa.</item>
    /// </list>
    /// </summary>
    [Serializable]
    public sealed class PerceptionDependencyMapParams
    {
