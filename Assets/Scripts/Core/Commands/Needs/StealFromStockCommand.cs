...
namespace Arcontio.Core
{
    ...
    /// Il ladro ruba 1 unità (o più) da uno stock di cibo che NON gli appartiene.
    ///
    /// Perché serve:
    ...
    public sealed class StealFromStockCommand : ICommand
    {
        ...
        public void Execute(World world, MessageBus bus)
        {
            ...
            // ACTION TRACE (debug/overlay): furto da stock visibile.
            ...
            int stolen = _units;
            if (stolen > stock.Units) stolen = stock.Units;
            ...
            Arcontio.Core.Logging.ArcontioLogger.Info(
