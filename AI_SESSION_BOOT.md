...
1. `TASKBOARD_CODEX.md`  
   = verità operativa corrente, macro job attivo, campagne congelate, priorità ingegneristica attuale.
...
6. `ARCONTIO_Roadmap_Notion.md`
   = sequenziamento macro di implementazione a lungo termine.
...
ARCONTIO è attualmente in una fase di stabilizzazione a doppio binario:

### Binario A — Stabilizzazione repository / workflow AI
Attivo:
- normalizzazione workflow Codex
- disciplina deterministica dei branch
- validazione pubblicazione GitHub
- coerenza dei report AI
- protocollo di sincronizzazione documentale

### Binario B — Costruzione documentazione costituzionale
Attivo:
- costruzione sezione costituzionale Notion
- istituzionalizzazione Decision Records
- architettura mirror ARCONTIO_docs
- pipeline audit codice -> documenti costituzionali -> decision records

Questo significa che governance repository e costruzione della memoria architetturale hanno attualmente priorità rispetto all'accelerazione di feature gameplay ampie.
