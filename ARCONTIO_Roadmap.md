...
| v0.70.05 | Inspector ViewModel/tab | In corso - sottostep v0.70.05.04.03 completato |
...
| v0.70.05.04.03 | Allineamento tabellare a sinistra delle righe info RightInspector | Fatto su branch `ai-task/v0.70.05.04.03-info-row-left-align` |
